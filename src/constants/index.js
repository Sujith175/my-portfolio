...
const projects = [
  ...
  {
    name: "Dreams E-commerce",
    description:
      "This robust back-end system, built with Node.js, Express, Prisma, and MySQL.It features secure user authentication, dynamic product catalog management",
    tags: [
      {
        name: "Mysql",
        color: "blue-text-gradient",
    ...
    image: ecom,
    source_code_link: "",
    project_link: "https://ecom-stag.codesprint.cloud",
  },
];
